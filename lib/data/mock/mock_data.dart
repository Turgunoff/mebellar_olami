...
class MockData {
  ...
  static const List<CategoryModel> categories = [
    CategoryModel(
      ...
      iconName: 'bed',
      children: [
        CategoryModel(id: 'cat_1_1', name: 'Karavotlar', parentId: 'cat_1', iconName: 'bed'),
        CategoryModel(id: 'cat_1_2', name: 'Shkaflar', parentId: 'cat_1', iconName: 'door_sliding'),
        CategoryModel(id: 'cat_1_3', name: 'Tumbalar', parentId: 'cat_1', iconName: 'nightlight'),
      ],
    ),
    CategoryModel(
      id: 'cat_2',
      ...
      iconName: 'weekend',
      children: [
        CategoryModel(id: 'cat_2_1', name: 'Divanlar', parentId: 'cat_2', iconName: 'weekend'),
        CategoryModel(id: 'cat_2_2', name: 'Stollar', parentId: 'cat_2', iconName: 'table_restaurant'),
        CategoryModel(id: 'cat_2_3', name: 'Kresollar', parentId: 'cat_2', iconName: 'chair'),
      ],
    ),
    CategoryModel(
      id: 'cat_3',
      ...
      iconName: 'kitchen',
      children: [
        CategoryModel(id: 'cat_3_1', name: 'Oshxona stollari', parentId: 'cat_3', iconName: 'table_restaurant'),
        CategoryModel(id: 'cat_3_2', name: 'Stullar', parentId: 'cat_3', iconName: 'chair_alt'),
        CategoryModel(id: 'cat_3_3', name: 'Oshxona javonlari', parentId: 'cat_3', iconName: 'shelves'),
      ],
    ),
    CategoryModel(
      id: 'cat_4',
      ...
      children: [
        CategoryModel(id: 'cat_4_1', name: 'Ofis stollari', parentId: 'cat_4', iconName: 'desk'),
        CategoryModel(id: 'cat_4_2', name: 'Ofis kreslosari', parentId: 'cat_4', iconName: 'chair'),
        CategoryModel(id: 'cat_4_3', name: 'Kitob javonlari', parentId: 'cat_4', iconName: 'shelves'),
      ],
    ),
    CategoryModel(
      id: 'cat_5',
